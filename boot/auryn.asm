...
; auryn_fill, auryn_scroll, auryn_paint, auryn_putc, auryn_puts
; Depends: fb_base, fb_width, fb_height, fb_ppsl, cursor_x,
;          cursor_y, current_color, font_data (in data.asm)
; =============================================================
